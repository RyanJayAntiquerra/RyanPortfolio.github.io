...
<body>
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav d-flex justify-content-center flex-grow-1">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="project.php" role="button"
    ...
    <div class="projects">
        <div class="firstProject">
            <div class="picture">
                <img src="image/firstProject.png" alt="">
            </div>
            <div class="des">
                <h2>Attendance Monitoring System</h2>
                <p>a software application specifically designed 
                    to record and track the presence of individuals 
                    within an organization or an event. It provides a 
                    systematic way of capturing attendance data, which 
                    can be crucial for various purposes such as payroll
                     management, academic grading, compliance monitoring, 
                     and overall organizational efficiency.</p>
            </div>
        </div>
        <div class="secondProject">
            <div class="picture">
                <img src="image/secondProject.jpg" alt="">
            </div>
            <div class="des">
                <h2>Business Centralized Web Portal</h2>
                <p>a unified platform where businesses can consolidate 
                    and manage various aspects of their operations, 
                    communications, and services through a single online 
                    interface. This portal typically integrates functionalities 
                    that facilitate communication, collaboration, information
                     sharing, and business transactions among stakeholders 
                     such as employees, customers, suppliers, and partners.</p>
            </div>
        </div>
        <div class="thirdProject">
            <div class="picture">
                <img src="image/thirdProject.png" alt="">
            </div>
            <div class="des">
                <h2>Food Ordering System</h2>
                <p>the process of ordering food from restaurants online. 
                    Customers can browse menus, customize orders, and securely
                     pay through the app. Restaurants receive orders instantly,
                      prepare them, and update customers on their status. These
                       apps also offer order tracking, customer feedback, 
                       and promotional features, enhancing convenience and 
                       efficiency for users and restaurants.</p>
            </div>
        </div>
        <div class="contactme">
            ...
            <div class="connected">
                ...
                <div class="location2">
                    <a href="https://www.facebook.com/ryanjay.antiquerra"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30"
